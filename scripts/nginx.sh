...
sudo cp "/home/ubuntu/project/TazosMon-Backend/nginx/nginx.conf" "/etc/nginx/sites-available/bba"
...
sudo ln -sf "/etc/nginx/sites-available/bba" "/etc/nginx/sites-enabled/"
